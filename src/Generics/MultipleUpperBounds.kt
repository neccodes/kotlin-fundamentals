...
fun main(args: Array<String>) {
    ...
    addPlayer(CounterStrikePlayer("Player 1")) // it doesn't work because CounterStrikePlayer doesn't implement Listener.
    addPlayer(FootballPlayer("Player 1")) // it works because FootballPlayer implements Listener interface and inherit from Player.
}
